...
int main(void) {
    ...
    printf("Binding successful. Listening for incoming messages...\n");
    ...
    if (sendto(socket_desc, server_message, strlen(server_message), 0, (struct sockaddr*)&client_addr, client_size) < 0) {
        printf("Can't send\n");
        return -1;
    }
